...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'menumanager_weeklymenu', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('start_date', self.gf('django.db.models.fields.DateField')()),
            ('end_date', self.gf('django.db.models.fields.DateField')()),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'menumanager', ['WeeklyMenu'])

        # Adding model 'MenuItem'
        db.create_table(u'menumanager_menuitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('menu', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['menumanager.WeeklyMenu'])),
        ...
        db.send_create_signal(u'menumanager', ['MenuItem'])


    def backwards(self, orm):
        # Deleting model 'WeeklyMenu'
        db.delete_table(u'menumanager_weeklymenu')

        # Deleting model 'MenuItem'
        db.delete_table(u'menumanager_menuitem')
    ...
    models = {
        ...
        u'menumanager.menuitem': {
            'Meta': {'object_name': 'MenuItem'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'menu': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['menumanager.WeeklyMenu']"}),
        ...
        u'recipemanager.recipe': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.URLField', [], {'max_length': '400', 'null': 'True', 'blank': 'True'}),
            ...
            'url': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '400', 'blank': 'True'})
        },
        u'taggit.tag': {
