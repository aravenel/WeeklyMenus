...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WeeklyMenu.owner'
        db.add_column('menumanager_weeklymenu', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'MenuItem.owner'
        db.add_column('menumanager_menuitem', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WeeklyMenu.owner'
        db.delete_column('menumanager_weeklymenu', 'owner_id')

        # Deleting field 'MenuItem.owner'
        db.delete_column('menumanager_menuitem', 'owner_id')
