...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'recipemanager_recipe', (
            ...
            ('url', self.gf('django.db.models.fields.URLField')(default=None, max_length=400, blank=True)),
            ...
            ('image', self.gf('django.db.models.fields.URLField')(max_length=400, null=True, blank=True)),
        ))
