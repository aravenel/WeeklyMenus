...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('recipemanager_recipe', 'rating_score')

        # Deleting field 'Recipe.rating_votes'
        db.delete_column('recipemanager_recipe', 'rating_votes')


    def backwards(self, orm):
        # Adding field 'Recipe.rating_score'
        db.add_column('recipemanager_recipe', 'rating_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Recipe.rating_votes'
        db.add_column('recipemanager_recipe', 'rating_votes',
