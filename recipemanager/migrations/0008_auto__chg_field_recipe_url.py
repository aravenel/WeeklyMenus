...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Recipe.url'
        db.alter_column('recipemanager_recipe', 'url', self.gf('django.db.models.fields.URLField')(max_length=400))

    def backwards(self, orm):

        # Changing field 'Recipe.url'
        db.alter_column('recipemanager_recipe', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))
