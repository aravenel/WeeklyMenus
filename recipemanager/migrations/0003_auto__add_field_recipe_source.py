...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('recipemanager_recipe', 'source',
                      self.gf('django.db.models.fields.CharField')(default='web', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recipe.source'
        db.delete_column('recipemanager_recipe', 'source')
